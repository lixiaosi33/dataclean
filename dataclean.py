...
file_list = ['P1','P2','P3','P4','P5','P7','P9']
...
def create_freshdataset():
    file_fresh_train = os.path.dirname(os.getcwd())+'/data/7class/7train.csv'
    file_fresh_test = os.path.dirname(os.getcwd())+'/data/7class/7test.csv'
